...
class Heroi(Personagem):
    ...
    def ataque_especial(self, alvo):
        dano = random.randint(self.get_nivel() * 5, self.get_nivel() * 8)   # Dano aumentado, EX: se o nivel é 5 o dano vai de 25 a 40
        alvo.receber_ataque(dano)
...
class Jogo:
    ...
    def __init__(self):
        self.heroi = Heroi('Hero', 100, 5, 'Super Força')
        self.inimigo = Inimigo('Morcego', 75, 4, 'Voador')
